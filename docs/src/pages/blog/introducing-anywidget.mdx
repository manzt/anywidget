...
import widgetOverviewImg from "../../../public/widget-overview.png";
import clientJsDiagramImg from "../../../public/client-js-diagram.png";
import anywidgetOverviewImg from "../../../public/anywidget-overview.png";
...
<Image src={widgetOverviewImg} alt="two components of a Jupyter widget, the JS front end and Python backend" />
...
<Image src={clientJsDiagramImg} alt="Widget front-end source code (JavaScript) requires is transformed and packaged into separate files for JupyterLab, Jupyter notebooks, Google Colab, VS Code" />
...
<Image src={anywidgetOverviewImg} alt="overview of anywidget implementation. anywidget loads and executes widget JavaScript code sent from the Python kernel" />
