...
> **EDIT**(2024-01-31): Since v0.9, it is preferred to use <u>anywidget lifecycle
> hooks</u> to define custom widgets. The JavaScript in the code snippets below
> have been updated with this API.
