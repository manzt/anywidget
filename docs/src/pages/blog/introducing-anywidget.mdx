---
title: "Introducing anywidget: Custom Jupyter Widgets Made Easy"
layout: ../../layouts/MainLayout.astro
authors: ["Trevor Manz"]
image: {
	src: "https://user-images.githubusercontent.com/24403730/213603834-ab15b58a-b1dd-4623-8586-84b9b8496e6d.png",
...
Widget authors are thus tasked with not only packaging their JavaScript
correctly for classic Jupyter notebooks but also for ensuring it can be used in multiple notebook
environments, each with their own requirements and quirks.
...
front-end tooling (i.e., `yarn`, Webpack, Babel, ESLint, and Jest are prerequisites) and substantial
...
1. Familiarize themselves with front-end build tooling and packaging
...
modern front-end development also targeting ESM. The [Vite plugin](/en/bundling#development)
...
to front-end view. This example is slightly more sophisticated in that the
`render` function synchronizes the model state between the widget front end and
...
front end relies on in the Jupyter Widgets [documentation](https://ipywidgets.readthedocs.io/en/8.0.2/examples/Widget%20Custom.html#Models-and-views).
