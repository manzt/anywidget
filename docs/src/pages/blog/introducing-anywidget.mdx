...
>
> <a href="/blog/a-year-with-anywidget#introducing-widget-lifecycle-hooks">
>   anywidget lifecycle hooks
> </a>
> to define custom widgets. The JavaScript in the code snippets below have been updated to reflect
> this usage.
