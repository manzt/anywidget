...
import widgetLifeCycleImg from "../../../public/widget-lifecycle.png";
...
<Image src={widgetLifeCycleImg} alt="The main parts of the widget lifecyle, including model initialization and view rendering" />
