...
_TL;DR: [**anywidget**](https://github.com/manzt/anywidget) is a new Python library which <u>greatly</u>
...
and bundlers, 2.) can prototype widgets from within a notebook, and 3.)
get a modern frontend developer experience. **anywidget** allows you to write code like this,_
