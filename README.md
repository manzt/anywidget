...
export function render(view) {
  ...
  get_count(); // initialize
  view.model.on("change:count", get_count);
...
<img alt="button indicating the number of times it has been clicked" src="https://user-images.githubusercontent.com/24403730/211373372-628c0829-8bd5-45b6-94db-1da496f0bdc3.png">
